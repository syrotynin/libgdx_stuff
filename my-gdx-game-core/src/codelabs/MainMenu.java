...
import codelabs.box2d.utils.Box2DSamples;
import codelabs.utils.Sample;
import codelabs.utils.SampleUtils;
...
public class MainMenu implements Screen {
	...
	public void show() {
		...
		stage = new Stage(new StretchViewport(Codelabs.TARGET_WIDTH, Codelabs.TARGET_WIDTH
				* (Gdx.graphics.getHeight() / (float) Gdx.graphics.getWidth())), batch);
